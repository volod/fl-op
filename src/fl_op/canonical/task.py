"""Canonical Task abstractions (spec 11.5)."""
...
class MaterialRequirement(BaseModel):
    """A consumable requirement for a task (spec 11.5 materialRequirements)."""
...
class Task(BaseModel):
    """A unit of work requested by a farmer or generated by a contract (spec 11.5)."""
